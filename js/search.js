...
var ARTICLES = [
  ...
  { id: 'p1', type: 'page', tag: 'Page', topic: 'general',
    ...
    excerpt: 'OceanCloud Consultants provides SharePoint consulting, M365 migration, Power Platform, Copilot readiness, and Teams services across the United States.',
  ...
  { id: 'p3', type: 'page', tag: 'Page', topic: 'general',
    title: 'About OceanCloud Consultants',
    excerpt: 'Review OceanCloud Consultants’ public technical work, source-backed guidance, contact details, and delivery approach.',
  ...
  { id: 'c2', type: 'casestudy', tag: 'Case Study', topic: 'migration',
    title: 'Hartwell NHS Trust — Controlled M365 Migration',
    excerpt: 'Migrated 2,400 mailboxes, 18TB of file share data, and legacy SharePoint 2013 using staged cutover and post-migration validation.',
    url: 'case-studies', dateDisplay: '', dateSort: '' },
