...
SERVICES = [
    {
        ...
        "proof": [("Fixed-price delivery", "A written scope and price before implementation starts."), ("Security by design", "Permissions, lifecycle, and governance built into the solution."), ("Scoped post-launch support", "The support period, response targets, and ownership are documented for each engagement.")],
...
<html lang="en"><head>
  ...
  <meta property="og:type" content="website" /><meta property="og:site_name" content="OceanCloud Consultants" /><meta property="og:title" content="{esc(service['title'])}" /><meta property="og:description" content="{esc(service['description'])}" /><meta property="og:url" content="{canonical}" /><meta property="og:image" content="{SITE}/assets/og-services.jpg" />
...
<footer><div class="container"><div class="footer-grid"><div class="footer-brand"><div class="logo-text"><div class="logo-mark">OC</div>Ocean<span>Cloud</span></div><p>Microsoft 365 and SharePoint consulting focused on secure, usable, maintainable outcomes.</p></div><div class="footer-col"><h4>Services</h4><ul><li><a href="/sharepoint-consulting">SharePoint Consulting</a></li><li><a href="/microsoft-365-migration">M365 Migration</a></li><li><a href="/microsoft-365-copilot-readiness">Copilot Readiness</a></li><li><a href="/power-platform-consulting">Power Platform</a></li><li><a href="/sharepoint-intranet-development">Intranet Development</a></li></ul></div><div class="footer-col"><h4>Company</h4><ul><li><a href="/about">About</a></li><li><a href="/editorial-policy">Editorial Policy</a></li><li><a href="/case-studies">Case Studies</a></li><li><a href="/guides">Guides</a></li><li><a href="/contact">Contact</a></li></ul></div><div class="footer-col"><h4>Contact</h4><ul><li><a href="mailto:oceancloudconsults@gmail.com">oceancloudconsults@gmail.com</a></li><li><a href="tel:+14698094053">Main: +1 (469) 809-4053</a></li><li><a href="https://wa.me/19176753126" target="_blank" rel="noopener noreferrer">WhatsApp: +1 (917) 675-3126 ↗</a></li><li><span>Mon–Fri, 9 AM–6 PM EST</span></li></ul></div></div><div class="footer-bottom"><div class="footer-bottom-inner"><span class="fb-copy">&copy; 2026 OceanCloud Consultants</span><div class="fb-right"><a href="/privacy">Privacy</a><span class="fb-sep">·</span><a href="/terms">Terms</a></div></div></div></div></footer>
